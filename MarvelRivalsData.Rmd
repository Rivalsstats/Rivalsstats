    ...
    <div id="{hero_name_clean}_Card" class="card h-100 shadow mb-3 p-3 dark-card">
      ...
      <div class="card-body">
        ...
        <div id="RoleAndType" class="d-flex align-items-center mb-2">
          <img src="icons/role_icons/{row$role}.png" alt="{row$role}" class="me-2 role" style="width: 24px; height: 24px;">
        ...
        <!-- Overall Stats -->
        <p class="card-text">
          <div>Winrate: <span class="{winrate_class} overall-winrate">{row$win_rate}%</span></div>
          <div>Pickrate: <span class="badge bg-info overall-pickrate">{row$pick_rate}%</span></div>
        </p>
...
generate_teamcomp_icons <- function(comp_string) {
  ...
  icons <- sapply(ordered_data, function(item) {
    rep_icons <- paste(rep(glue::glue('<img src="icons/role_icons/{item$role}.png" class="icon-sm" alt="{item$role}">'),
                           item$count), collapse = " ")
    return(rep_icons)
  })
