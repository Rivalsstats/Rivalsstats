...
top_game_per_hero <- consistent_players %>%
  ...
  slice_max(overall_score, n = 1, with_ties = FALSE) %>%
  ungroup()
...
build_match_html <- function(match_row) {
    ...
    <div class="highlight-match">
      <div class="match-header">
        ...
        <div class="details">
          ...
          <button id="copy-btn" class="btn btn-sm btn-outline-light ms-2">Copy Replay ID</button>
        </div>
      </div>
...
build_scoreboard_section <- function(hero_name, scoreboard_list) {
  ...
  scoreboard_section_html <- build_match_html(match_row_list)
