...
asssure_match_data <- function(match_uid,match_info){
  ...
  if(file.exists(file_path)) {
    ...
    if(as.character(match_uid)==as.character("6711329_1742141444_249_11001_50")) {
      print(match_uid)
...
for(match_uid in unique(matches$match_uid)){
  # Get match metadata row (assuming one row per match)
  match_info <- matches[matches$match_uid == match_uid, ]
